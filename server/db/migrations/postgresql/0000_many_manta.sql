...
ALTER TABLE "api_call_stats" ADD CONSTRAINT "api_call_stats_last_api_call_id_api_calls_id_fk" FOREIGN KEY ("last_api_call_id") REFERENCES "public"."api_calls"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "api_lists" ADD CONSTRAINT "api_lists_category_id_api_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."api_categories"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "api_lists" ADD CONSTRAINT "api_lists_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "api_lists" ADD CONSTRAINT "api_lists_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fab_menu_items" ADD CONSTRAINT "fab_menu_items_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fab_menu_items" ADD CONSTRAINT "fab_menu_items_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "api_lists_category_idx" ON "api_lists" USING btree ("category_id");--> statement-breakpoint
CREATE INDEX "api_lists_enabled_sort_idx" ON "api_lists" USING btree ("is_enabled","sort_order");--> statement-breakpoint
CREATE INDEX "api_lists_status_idx" ON "api_lists" USING btree ("status");--> statement-breakpoint
CREATE INDEX "api_lists_deleted_at_idx" ON "api_lists" USING btree ("deleted_at");--> statement-breakpoint
