...
<template>
  <div>
    ...
    <!-- 菜单 -->
    <nav
      class="fixed right-5 bottom-[88px] z-[121] w-[280px] bg-surface border border-border rounded-[14px] shadow-[0_6px_16px_rgba(0,0,0,0.06)] transition-all duration-200"
      :class="
        isOpen
